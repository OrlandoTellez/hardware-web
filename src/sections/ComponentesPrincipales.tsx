      ...
      <section className={styles.section}>
        ...
        <section className={styles.cards_section}>
          <div className={styles.cards}>
            ...
            <CardHardwareName name="Almacenamiento" icon={IconCpu.src} />
            <CardHardwareName name="Memoria RAM" icon={IconCpu.src} />
            <CardHardwareName name="Pantalla/Gráficos" icon={IconCpu.src} />
          </div>
